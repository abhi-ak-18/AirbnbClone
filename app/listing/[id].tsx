...
const Page = () => {
  ...
  const scrollOffest = useScrollViewOffset(scrollRef);
      ...
      headerRight: () => (
        <View style={styles.bar}>
          <TouchableOpacity style={styles.roundButton} onPress={shareListing}>
            <Ionicons name="ios-share" size={22} color="#000"></Ionicons>
          </TouchableOpacity>
  ...
  const headerAnimatedStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(scrollOffest.value,[0,IMG_HEIGHT /1.5],[0,1]),
    };
  });
      ...
      >
        ...
        >
          <TouchableOpacity style={styles.footerText}>
            <Text style={styles.footerPrice}>₹ {listing.price * 80}</Text>
            <Text>night</Text>
          </TouchableOpacity>
          <TouchableOpacity
